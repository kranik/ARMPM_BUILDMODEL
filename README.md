...
**March 2019 - I have added examples of the model coefficients, generated by the methodology in [MODELS.md](MODELS.md).**
...
I have added a few tables with example events and coefficients, extracted from my dissertation. Please refer to [MODELS.md](MODELS.md).
