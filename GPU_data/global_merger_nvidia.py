...
path13 = "./run_64_nvidia/power_measurement_merged_global.txt"
m = open(path13,'w')
for benchmark in benchmarks:
	for freq in freqs:
		...
		for run in runs:
			fline=0
			path0 = "./run_64_nvidia/power_measurement_log_c0_"+benchmark+"_"+freq+".txt"
			path1 = "./run_64_nvidia/power_measurement_log_c1_"+benchmark+"_"+freq+".txt"
			path2 = "./run_64_nvidia/power_measurement_log_c2_"+benchmark+"_"+freq+".txt"
			path3 = "./run_64_nvidia/power_measurement_log_c3_"+benchmark+"_"+freq+".txt"
			path4 = "./run_64_nvidia/power_measurement_log_c4_"+benchmark+"_"+freq+".txt"
			path5 = "./run_64_nvidia/power_measurement_log_c5_"+benchmark+"_"+freq+".txt"
			path6 = "./run_64_nvidia/power_measurement_log_c6_"+benchmark+"_"+freq+".txt"
			path7 = "./run_64_nvidia/power_measurement_log_c7_"+benchmark+"_"+freq+".txt"
			path8 = "./run_64_nvidia/power_measurement_log_c8_"+benchmark+"_"+freq+".txt"
			path9 = "./run_64_nvidia/power_measurement_log_c9_"+benchmark+"_"+freq+".txt"
			path10 = "./run_64_nvidia/power_measurement_log_c10_"+benchmark+"_"+freq+".txt"
			path11 = "./run_64_nvidia/power_measurement_log_c11_"+benchmark+"_"+freq+".txt"
			path12 = "./run_64_nvidia/power_measurement_log_c12_"+benchmark+"_"+freq+".txt"
